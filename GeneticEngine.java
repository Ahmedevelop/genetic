...
public class GeneticEngine{
	...
	public static final int OCTET_LENGTH = 64; // kolvo bitov for long
	...
	private int genomLength; //dlina genma v bitax
	private int sizeOfArray;
	private long generationCount; //kolvo pokoleniy
	private int individualCount; // kolvo inividov v pokolenii
	private SelectionType selectionType; //tip selekcii
	private CrossingType crossingType; //tip skrewivaniya
	private boolean useMutation; //ispolzovat mutaciyu	
	private double mutationPercent; //esli prediduwee true,to kak chasto uzalas mutaciya
	
	//sdelat setteri i getteri
